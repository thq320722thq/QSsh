...
* 'configure.py --os=mingw --cpu=x86_32 --cc-bin=i686-w64-mingw32-g++.exe --ar-command=i686-w64-mingw32-gcc-ar'
*
* Target
*  - Compiler: i686-w64-mingw32-g++.exe -m32 -pthread -std=c++11 -D_REENTRANT -O3
*  - Arch: x86_32
*  - OS: mingw
*/
...
#define BOTAN_VERSION_DATESTAMP 20210509


#define BOTAN_VERSION_RELEASE_TYPE "release"

#define BOTAN_VERSION_VC_REVISION "git:d4bd416702a65eddcc14ee06b9c1b674631e6ae3"
