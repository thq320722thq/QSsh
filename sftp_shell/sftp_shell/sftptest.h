...
private:
    ...
    enum State {
        ...
        CheckingDirAttributes, CheckingDirContents, RemovingDir, ChannelClosing, Disconnecting, DownloadingDir, UploadingDir, StatFiles
    };
    ...
    JobMap m_dirUploadJobs;
    JobMap m_dirDownloadJobs;
    JobMap m_statFilesJobs;
    ...
    QSsh::SftpJobId m_upDirJob;
    QSsh::SftpJobId m_downDirJob;
    QSsh::SftpJobId m_statJob;
